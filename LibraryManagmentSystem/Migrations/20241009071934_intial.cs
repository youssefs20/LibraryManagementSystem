        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    returnedBooksCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Return_AspNetUsers_LibrarianId",
                        column: x => x.LibrarianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Return_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksCheckedOuts", x => new { x.CheckOutId, x.BookId });
                    table.ForeignKey(
                        name: "FK_BooksCheckedOuts_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BooksCheckedOuts_CheckOuts_CheckOutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksCheckedOuts_BookId",
                table: "BooksCheckedOuts",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckOuts_LibrarianId",
                table: "CheckOuts",
                column: "LibrarianId");
